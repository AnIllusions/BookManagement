...
public class GetbookServletOther extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.setCharacterEncoding("utf-8");//解决乱码
		 ...
		 String getothername=request.getParameter("lyrxm");
		 
		 HttpSession session=request.getSession(true);
		 Operator operator=(Operator) session.getAttribute("denglu");
		 
		 RuKuDao dao =new RuKuDaoImpl();
	     boolean b=dao.getBookOther(textbookid, getamount, getothername, operator);
	     System.out.println("GetbookServlet.Other.b="+b);
			if(b){
