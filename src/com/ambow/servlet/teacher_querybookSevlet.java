...
public class teacher_querybookSevlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       session.removeAttribute("tTextBooks");
       session.setAttribute("tTextBooks", textBooks);
      
       request.getRequestDispatcher("/static/module/storage/storage001/teacher/show_book_query.jsp").forward(request, response);
	}
