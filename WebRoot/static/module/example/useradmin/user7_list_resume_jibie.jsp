...
<body>
<h3 id="subTitle">用户管理－恢复</h3>
<ul id="button">
	<li><a href="user1_list_jibie.htm">返回</a></li>
</ul>
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
    <tr>
        <th width="15%" align="center" nowrap="nowrap" class="title2">所属级别</th>
    ...
    <tr class="within2bg">
        ...
        <td>工程师</td>
        <td align="center">激活</td>
        <td align="center" class="font_dark"><input type="checkbox" name="checkbox22" value="checkbox" /></td>
    </tr>
    <tr class="within2bg">
        <td align="center">－－</td>
        ...
        <td>工程师</td>
        <td align="center">激活</td>
        <td align="center" class="font_dark"><input type="checkbox" name="checkbox3" value="checkbox" /></td>
    </tr>
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="yesno">
    <tr>
        <td align="center"><input name="Submit2" type="submit" class="btn_1" value="确定" />
            &nbsp;<a href="user1_list.htm">确定</a>&nbsp;
            <input name="Submit3" type="reset" class="btn_1" value="取消" /></td>
    </tr>
</table>
