...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
    <form action="" method="post" name="form2" id="form2">
        <tr>
            ...
            <td nowrap="nowrap"><input name="textfield" type="text" class="input2" />                <input name="Submit" type="submit" class="buttonInp" value="查 询"></td>
        </tr>
    </form>
</table>
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table" style="margin-top:10px;">
    <form action="" method="post" name="form1" id="form1">
        <tr>
            <th width="21%" align="center" nowrap="nowrap" class="title2">企业名称</th>
            <th width="13%" align="center" nowrap="nowrap" class="title2">帐号</th>
            <th width="12%" align="center" nowrap="nowrap" class="title2">企业类型</th>
            <th width="16%" align="center" nowrap="nowrap" class="title2">单位资质</th>
            <th width="18%" align="center" nowrap="nowrap" class="title2">联系方式</th>
            <th width="13%" align="center" nowrap="nowrap" class="title2">状态</th>
            <th width="7%" align="center" nowrap="nowrap" class="title2">选中</th>
        </tr>
        <tr class="within2bg">
