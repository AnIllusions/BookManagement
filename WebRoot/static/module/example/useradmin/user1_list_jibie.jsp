...
<body>
<h3 id="subTitle">用户管理-按级别</h3>
<ul id="button">
	<li><a href="user3_new.htm">新 建</a></li>
	<li><a href="user5_list_del_jibie.htm">删 除</a></li>
	<li><a href="user6_list_pause_jibie.htm">暂 停</a></li>
	<li><a href="user7_list_resume_jibie.htm">恢 复</a></li>
</ul>
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
    <form action="" method="post" name="form2" id="form2">
        <tr>
            <td width="20%" nowrap="nowrap">按级别查询：</td>
            <td nowrap="nowrap"><select name="jibie">
                <option selected="selected" value=""> 选择级别</option>
