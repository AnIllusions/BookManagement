...
<body>
	<h3 id="subTitle">查询学生</h3>
	<ul id="button">
		<li><a href="../../main.jsp">返回</a></li>
	</ul><br></br>
	<form action="<%=path %>/StudentServlet?status=query" method="post" name="form1" id="form1">
		<table width="90%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td width="20%" align="center" nowrap="nowrap">输入学号：</td>
				<td width="80%" align="left" nowrap="nowrap"><input
					name="number" type="text" class="input2" id="number"/></td>
			</tr>
		</table>
		<table width="90%" border="0" align="center" cellpadding="0"
			cellspacing="0" class="table2">
