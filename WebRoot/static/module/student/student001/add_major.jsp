...
<body>
	<h3 id="subTitle">添加专业</h3>
	<ul id="button">
		<li><a href="../../main.jsp">返回</a></li>
	</ul>
	<form action="<%=path %>/MajorServlet?status=add" method="post" name="frm" onsubmit="return yan()">
		<table width="90%" border="0" align="center" cellpadding="0"
			cellspacing="0" class="table">
			<tr>
				<th colspan="4" class="p4"><span class="title2"><h6>填写专业信息:</h6></span></th>
			</tr>
			<tr>
				<td width="20%" align="right" class="title2">专业名称：</td>
				<td width="80%" class="within2bg"><input name="majorName"
					type="text" class="input2" id="majorName"/></td>
			</tr>
			<tr>
