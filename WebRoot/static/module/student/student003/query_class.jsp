...
<body>
	<h3 id="subTitle">查询班级</h3>
	<ul id="button">
		<li><a href="../../main.jsp">返回</a></li>
	</ul><br></br>
	<form action="<%=path %>/BJiServlet?status=query" method="post" name="form1" id="form1">
		<table width="90%" border="0" align="center" cellpadding="0"
			cellspacing="0" class="table2">
			<tr align="left" class="within2bg">
				<td colspan="2" class="no_note"><input type="radio"
					name="radio" value="名称查询" checked="true" />按名称查询：</td>
			</tr>
			<tr>
				<td width="20%" align="center" nowrap="nowrap">输入班级名称：</td>
				<td width="80%" align="left" nowrap="nowrap"><input
					name="className" type="text" class="input2" /></td>
			</tr>
		</table>
		<table width="90%" border="0" align="center" cellpadding="0"
			cellspacing="0" class="table2">
			...
			<tr>
				<td align="center" class="title2">选择类别：</td>
			...
			<tr>
				<td width="20%" align="center" class="title2">选择层次：</td>
			...
			<tr>
				<td align="center" class="title2">选择专业：</td>
			...
			<tr>
				<td align="center" class="title2">选择年级：</td>
			...
			<!--  <tr>
				<td align="center" class="title2">选择班级：</td>
		...
		<table width="90%" border="0" align="center" cellpadding="0"
			...
			<tr align="center" class="within2bg">
				<td colspan="2" class="no_note"><input name="Submit"
