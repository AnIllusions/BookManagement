...
<body>
<%
System.out.println("进入了storage.other.jsp"); 
String radio=request.getParameter("radio");
List<TextBook> textbooks=(List<TextBook>)session.getAttribute("oTextBooks");
TextBook textbook=textbooks.get(Integer.parseInt(radio));
 %>
<h3 id="subTitle">其它领书</h3>
<form name="" method="post" action="<%=path%>/GetbookServletOther">
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  ...
  <tr>
    <td align="right" class="title2">领用人姓名：</td>
    <td colspan="2" class="within2bg">&nbsp;
        <input name="lyrxm" type="text" size="20" maxlength="20" class="input2" /></td>
  </tr>
</table>
