...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  ...
  <tr>
    ...
    <td colspan="3" valign="middle" class="within2bg"><input name="text" type="text" class="input2" value="" size="40" maxlength="40" /></td>
  </tr>
  <tr>
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table" style="margin-top:10px;">
    ...
    for(int i=0;i<n;i++){ %>
     ...
     <td>
     <form method="post" action="<%=path %>/editDeletetextbookServlet">
     <input type="hidden" name="textbookid" value="<%=request.getAttribute("textbookid"+i) %>"/>
