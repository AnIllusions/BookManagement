...
<body>
<%
System.out.println("进入了storage.teacher.jsp"); 
String radio=request.getParameter("radio");
List<TextBook> textbooks=(List<TextBook>)session.getAttribute("tTextBooks");
TextBook textbook=textbooks.get(Integer.parseInt(radio));
 %>
<h3 id="subTitle">教师领书</h3>
<form   method="post" action="<%=path%>/GetbookServletTeacher">
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  ...
  <tr>
    ...
    <td class="within2bg">可领数量：&nbsp;      <input type="text" class="input2" value=" <%=textbook.getAmount() %>" size="6" maxlength="6" readonly="true"/></td>
    </tr>
  <tr>
  ...
  <tr>
    <td align="right" class="title2">教师姓名：</td>
    <td colspan="2" class="within2bg">&nbsp;
        <input name="jsxm" type="text" size="20" maxlength="20" class="input2" /></td>
  </tr>
</table>
