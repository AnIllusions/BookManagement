...
<form name="" method="" action="<%=path%>/deliver_queryTeacherSevlet">
...
<tr>
		<td nowrap="nowrap">按出库时间查询：
			 ...
			 &nbsp;&nbsp;教师姓名：<input name="teachername" type="text" class="input2" size="10" maxlength="10" />(*可选)
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table" style="margin-top:10px;">
  ...
  <tr align="center" class="within2bg">
    <td colspan="11" class="no_note">没有符合条件的记录</td>
  </tr>
</table>
