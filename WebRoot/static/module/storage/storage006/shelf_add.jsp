...
<body>
<h3 id="subTitle">添加架位</h3>

<form name="form1" method="post" action="<%=path%>/huojiaServlet">
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
        <tr>
            <th colspan="4" align="center" class="title2">架位基本信息</th>
        </tr>
        <tr>
            <td width="13%" align="center" class="title2"><div align="right">架位名称：<br>
          </div></td>
          <td width="37%" class="within2bg">&nbsp;
            <input name="addname" type="text" class="input2" />
        ...
        <tr>
            ...
            <td class="within2bg"><textarea name="addremark" ></textarea></td>
        </tr>
    </table>
