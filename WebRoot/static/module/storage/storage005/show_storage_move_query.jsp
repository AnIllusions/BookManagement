...
<form action="/Book_System/static/module/storage/storage005/storage_move.jsp">
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
   ...
   <!-- 此处取第一条数据 -->
    <tr align="center" class="within2bg">
       <td><input name="sjh30" value="<%=request.getAttribute("sjh30")%>"/></td>
       <td><input name="jcmc30" value="<%=request.getAttribute("jcmc30")%>"/></td>
       <td><input name="sl30" value="<%=request.getAttribute("sl30")%>"/></td>
       <td><input name="choose" type="radio"/></td>
    </tr>
</table>
