...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table2">
	<form action="<%=path%>/rukuqueryServlet" method="post" name="form2" id="form2">
		<tr>
			<td width="" nowrap="nowrap" align="right">起始时间：</td>
			<td nowrap="nowrap"><input name="begintime" type="text" class="input2" />
			<td width="" nowrap="nowrap" align="right">终止时间：</td>
			<td nowrap="nowrap"><input name="endtime" type="text" class="input2" />
			
		</tr>
		<tr>
			
			<td width="" nowrap="nowrap" align="right">供应商名称：</td>
			<td nowrap="nowrap"><input name="suppliername" type="text" class="input2" />
			<td width="" nowrap="nowrap" align="right">教材名称：</td>
			<td nowrap="nowrap"><input name="bookname" type="text" class="input2" />
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table" style="margin-top:10px;">
    <form action="<%=path%>/rukuqueryServlet" method="post" name="form1" id="form1">
        <tr>
        ...
        for(int i=0;i<n;i++){ %>
        <tr class="within2bg">
            <td><%=request.getAttribute("suppliername1"+i) %></td>
       <td><%=request.getAttribute("textbookname1"+i) %></td>
       <td><%=request.getAttribute("price1"+i) %></td>
       <td><%=request.getAttribute("amount1"+i) %></td>
       <td><%=request.getAttribute("rukutime1"+i) %></td>
        </tr>
        <%
				}
			%>
