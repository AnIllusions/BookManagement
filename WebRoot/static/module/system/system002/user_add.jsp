...
<form name="form1" method="post" action="<%=path%>/AddAdminServlet">
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
        ...
        <tr>
          ...
          <td width="79%" class="within2bg">&nbsp;
            <input name="account" type="text" class="input2" /> 
...
<tr>
 ...
 <tr>
      ...
      <td class="within2bg">&nbsp;
            <input name="password2" type="password" class="input2" />
            <span class="STYLE1">* </span></td>
        </tr>
        <tr>
            <td align="right" class="title2">职位：</td>
            <td class="within2bg">&nbsp;
            <input name="post" type="text" class="input2" /></td>
        </tr>
