...
<%-- <link href="<%=path %>/static/css/leftMenu.css" rel="stylesheet"
	type="text/css" /> --%>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="leftMenu">
		...
		<tr id="list" style="display:none;">
			<td><table width="100%" border="0" cellpadding="0"
					...
					<tr>
						<!-- 当前修改 -->
						<td align="left"><a href="./system002/user_add.jsp"
							target='mainFrame' class="menu" onclick='tdClick(0)'>用户添加</a></td>
					</tr>
					<tr>
						<!-- ./system002/user_list.jsp -->
						<td align="left"><a
							href="<%=path%>/AdminListServlet?role=all" target='mainFrame'
							class="menu" onclick='tdClick(1)'>用户查询</a></td>
					</tr>
				</table></td>
		</tr>
		...
		<tr onclick="showobj(1)">
			<td><img src="../../images/yuebao.gif" width="24" height="24"
				...
				target="mainFrame">入库单管理</a></td>
		</tr>
		<tr id="list" style="display:none;">
			<td><table width="100%" border="0" cellpadding="0"
					cellspacing="0" class="leftMenu2">
					<tr>
						<!--  ./system001/order_list_name.jsp STOCK RECEIVE  SUPPLIER -->
						<td align="left"><a
							href="<%=path%>/StockReceiveServlet?supplier=all" target='mainFrame'
							class="menu" onclick='tdClick(0)'>入库单报销</a></td>
					</tr>
					<tr><!-- ./system001/order_list_name2.jsp -->
						<td align="left"><a href="<%=path %>/StockPaymentListServlet?payment=all&name=all"
							target='mainFrame' class="menu" onclick='tdClick(0)'>报销查询</a></td>
					</tr>
				</table></td>
		</tr>
	</table>
